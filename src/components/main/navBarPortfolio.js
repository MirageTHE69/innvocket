  ...
  return (
    <div className="px-4 md:px-12 font-roboto pt-5 md:pt-10">
      <div className="flex justify-between items-center">
        ...
        <div className=" w-screen flex items-center justify-center">
          <div className="w-[80%] md:w-[50%] bg-rebeccapurple  flex flex-row flex-wrap justify-between rounded-3xl shadow-md border border-gray-400 bg-black p-2">
            ...
            <a
              ...
              className={`nav home flex-1 p-2 md:p-4 text-center text-white text-xs md:text-sm no-underline ${
                activeTab === "Mobile"
                  ? "border border-green-500 rounded-2xl"
                  : ""
              }`}
        ...
        {/* Button */}
        <div className="w-[20%] md:w-[17%] bg-green-500 rounded-full px-2  self-center py-2  mb-2 md:mb-4 flex items-center justify-center relative hidden md:block">
          <span className="text-xs md:text-sm  px-6 ml-2 text-white md:mr-2">
            Get In Touch
          </span>
        </div>
      </div>
